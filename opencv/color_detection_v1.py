...
class Color_segmentation:
    ...
    def coordinate_transform(self, contours_info, ratio_x, ratio_y):
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        contours_info_b = detector.detect_biggest_color_region("b")
        if contours_info_b:
            ...
            # print 'w, h', contours_info[2], contours_info[3]
            contours_info_r = detector.detect_biggest_color_region("r")

            if contours_info_r:
                x, y = detector.coordinate_transform(contours_info_r, ratio_x, ratio_y)
                y = y - 20.5
                x = x - 29.5/2.
                x, y = -y, -x
